...
const ContactUs = () => {
  ...
  const inputVariants = {
    focus: { scale: 1.02, borderColor: "#9333ea", boxShadow: "0 0 0 2px rgba(147, 51, 234, 0.3)" },
    ...
    <div className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-16">
        ...
        >
          ...
          >
            Have questions or feedback? We'd love to hear from you! Reach out to the GreedHunter team using the form below.
          </motion.p>
        </motion.section>
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-16">
          ...
          >
            <h2 className="text-3xl font-bold mb-6 text-yellow-300">Send Us a Message</h2>
            ...
            {isSubmitted ? (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-yellow-300 mb-2">Message Sent!</h3>
          ...
          >
            <h2 className="text-3xl font-bold mb-6 text-yellow-300">Reach Out</h2>
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:hunter@greedhunter.com" className="text-gray-300 hover:text-yellow-300 transition-colors">hunter@greedhunter.com</a>
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-semibold text-purple-400 mb-1">Follow Us</h3>
                  <div className="flex space-x-4 mt-2">
                    {["Twitter", "Instagram", "Discord"].map((platform, index) => (
                      <motion.a
                        key={platform}
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-semibold text-purple-400 mb-1">Support Hours</h3>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { q: "How quickly will I receive a response?", a: "We aim to respond to all inquiries within 24 hours during business days." },
              { q: "Can I request a specific challenge?", a: "Absolutely! We welcome suggestions for new challenges. Share your ideas through this form." },
              { q: "How do I report a technical issue?", a: "Please use the contact form and select 'Technical Support' as the subject." },
              { q: "Do you offer partnerships?", a: "Yes, we collaborate with educational institutions and organizations. Contact us for details." }
            ].map((faq, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                <h3 className="text-lg font-semibold text-purple-400 mb-2">{faq.q}</h3>
        ...
        >
          ...
          <motion.div
            ...
            transition={{ delay: 0.2 }}
          >
            <h2 className="text-3xl font-bold text-yellow-300 mb-4">Stay Updated</h2>
            <p className="text-lg text-purple-200 mb-8 max-w-2xl mx-auto">Subscribe to our newsletter for the latest challenges, rewards, and platform updates.</p>
