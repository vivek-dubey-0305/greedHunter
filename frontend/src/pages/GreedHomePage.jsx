...
const HeroSection = () => {
  ...
  // Stats
  // const [stats, setStats] = useState({ totalUsers: 0, totalWinners: 0, totalPrizeDistributed: 0 });
  ...
  //         try {
  //             const { data } = await axios.get("http://localhost:8000/api/v1/users/homepage-stats");
  //           setStats(data);
  //           console.log("data..\n", data)
  //         } catch (error) {
  ...
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-black via-stone-950 to-indigo-950 text-white min-h-screen overflow-hidden">
        {/* Animated Background */}
        ...
        >
          ...
          >
            ...
            <p className="mt-6 text-xl text-gray-300 max-w-2xl mx-auto">
              Compete in quizzes, games, and challenges to win exclusive rewards
        ...
        <div className="text-white bg-gray-900 p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold text-yellow-400 mb-4">📊 Platform Statistics</h2>
            <p>Total Users: <span className="text-green-500">{stats.totalUsers}</span></p>
            <p>Users Won: <span className="text-blue-400">{stats.totalWinners}</span></p>
            <p>Total Prize Distributed: <span className="text-red-400">₹{stats.totalPrizeDistributed}</span></p>
        </div>
        </section> */}
