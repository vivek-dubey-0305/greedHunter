              ...
              {Object.keys(menuIcons).map((tab) => (
                ...
                >
                  <div className="py-3 px-4 flex items-center">
                    <div className="flex-shrink-0">{menuIcons[tab]}</div>
                    <AnimatePresence>
                      {sidebarOpen && (
                        <motion.span
                          variants={menuItemVariants}
              ...
              {scheduledEvents[activeSubTab]?.length === 0 ? (
                ...
                >
                  ...
                  <p className="text-gray-500 mt-2">
                    Events you {activeSubTab.toLowerCase()} will appear here
                  </p>
                </motion.div>
              ) : (
          ...
          {activeTab === "Badges" && (
            ...
            >
              ...
              <p className="text-gray-500 mt-2 max-w-md text-center">
                Complete events and unlock achievements to earn badges that
